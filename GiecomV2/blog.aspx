<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="blog.aspx.cs" Inherits="GiecomV2.blog" %>
                        ...
                        <div class="main row">
                            <div class="col-md-8 blog_left">
                                ...
                                <p class="para" align="justify">
                                    En el marco de la celebración de los 20 años del programa de Ingeniería de Sistemas, el Semillero de Programación realizó el evento académico "Maratón de Programación 2017 - II"
                                    Contamos con la participación de 85 equipos inscritos (170 estudiantes) repartidos así: Nivel 1: 47 equipos, Nivel 2: 38 equipos. En el nivel 1 nos acompañaron 8 equipos del Instituto Técnico Industrial de los grados 10 y 11.<br>
                                    Felicitaciones a todos los participantes y en especial a los equipos ganadores.
                                </p>
                                <br>
                                <br>
                                ...
                                <p class="para" align="justify">Proyecto de extensión social para el manejo de redes sociales con las personas de la tercera edad.  <br>
                                       El grupo de investigación GIECOM mediante un proyecto de extensión social, que se presentó a la Universidad de la Amazonia, pretende dar conocimientos a las personas de la tercera edad sobre el majeño de las redes sociales (Facebook, YouTube, Correo electrónico, etc.), esto con el objetivo de capacitar a estas personas frente a la actualidad mediante el uso de la tecnología.
